...
<head>
        ...
        <link rel="stylesheet" href="/css/helpdesk/myAnswer.css">
...
<body>
    <div class="body-wrap">
        <div class="menu-wrap">
            ...
            <div class="mini-menu">
                <div class="now-mini_menu_2">헬프데스크 관리</div> <!-- 현재 위치의 메뉴 -->  <!-- 1. 변경 메뉴에 맞게 내용 변경하기 -->
                <div class="now-mini_menu">내 답변 보기</div>
            </div>
        </div> <!-- 상단 메뉴바 wrap -->
        <div class="content-wrap"> 
            <div class="contentTitle_container">
                <div class="contentTitle-wrap">
                    <h1>내 답변 보기</h1> <!-- 2. 변경 메뉴에 맞게 내용 변경 하기 -->
                </div>
                    ...
                    <table id="mainTable">
                        ...
                        <c:forEach var="row" items="${map.list}">
                            <tr>
                                ...
                                <td>
                                    <div class="td_div">
    									<a href="/view_helpdeskEmp.do?BNO=${row.BNO}">${row.REP_DATE}</a>
									</div>
                                </td>
                            </tr>
                        </c:forEach>
