...
<body>
        ...
        <script>
            ...
            function changeService(){ //서비스 => 점검 내역서로 로드할 때
                ...
                $('.service_modal').load('/callResult.do'); // 점검 내역서 로드
                $('.service_modal').show();
            }

            function changeResult(){ // 점검 내역서 => 서비스로 로드할 때
                $('.service_modal').empty(); //비우기
                $('.service_modal').load('/callService.do'); // 점검 내역서 로드
                $('.service_modal').show();
            }
            ...
            $('#nextButton').on('click',function(){
                ...
                if(textChecker == "등록") {
                    ...
                    $('#nextButton').text("등록");
                    $('.service_modal').load('/callService.do');
                    $('.service_modal').show();
                }
            });
            ...
            $('#cancleButton').on('click', function(){
                ...
                if(goList) {
                    ...
                    location.href = '/go_viewList_C.do?BNO=' + sendBno ;
                } else {
                    return false;
                }
            });
