...
<table id="table8">
    <tr>
        ...
        <td>
            <input type="text" name="LIST_TITLE" id="LIST_TITLE" value="${load.LIST_TITLE}">
        </td>
    </tr>
    <tr>
        <th class="th_style">
...
<table id="table9">
    ...
    <tr>
        <td>
            <textarea name="INSPECTION_RESULT" wrap="hard" id="INSPECTION_RESULT"> ${load.INSPECTION_RESULT}</textarea>
        </td>
    </tr>
    <tr>
        <th class="th_style">
    ...
    <tr>
        <td>
            <textarea name="ETC" wrap="hard" id="ETC" >${load.ETC}</textarea>
        </td>
    </tr>
</table>
...
<table id="table11">
    <tr>
        ...
        <td>
            <input type="text" name="INSPECTOR_COM" id="INSPECTOR_COM" value="${load.INSPECTOR_COM}">
        </td>
        <th class="th_style">
            <div>확인자 소속</div>
        </th>
        <td>
            <input type="text" name="CHECKER_COM" id="CHECKER_COM" value="${load.CHECKER_COM}" >
        </td>
    </tr>
    <tr>
        <th class="th_style">
        ...
        <td>
            <input type="text" name="INSPECTOR" id="INSPECTOR" value="${load.INSPECTOR}" >
        </td>
        <th class="th_style">
            <div>확인자</div>
        </th>
        <td>
            <input type="text" name="CHECKER" id="CHECKER_U" value="${load.CHECKER}" >
        </td>
    </tr>
</table>
<script>
    $(document).ready(function(){
        $('.nonClick').css('pointer-events', 'none');
        
        $('#beforeButton').css('margin-right','33%');
        
        $('#CHECKER_U').on('input', function(){
        	var CHECKER_U = $(this).val();
        	CHECKER_U = CHECKER_U.replace(/[^ㄱ-ㅎ가-힣a-zA-Z]/g, '');
        	 $(this).val(CHECKER_U);
        });
    })
</script>