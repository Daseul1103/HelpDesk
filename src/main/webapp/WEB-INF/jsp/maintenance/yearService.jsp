...
<div class="listType_contianer">
    ...
    <table id="table2">
        <tr>
            ...
            <td>
                <div>
                    <input type="checkbox" id="CONTRACT_TYPE" name="CONTRACT_TYPE"  value="year" checked>
                    <label for="CONTRACT_TYPE">연간 계약</label>
                </div>
            </td>
        </tr>
        <tr>
    ...
    <table id="table7">
        <tr>
            ...
            <td>
                <label for="CHECKER">
                <div>
                    <input type="text" name="CHECKER" id="CHECKER_U">
                </div>
                </label>
            </td>
        </tr>
