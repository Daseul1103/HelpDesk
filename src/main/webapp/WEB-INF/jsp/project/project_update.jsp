...
<body>
    <div class="topMenu_comtatiner"> <!-- 상단 메뉴바 컨테이너 시작 -->
        ...
        <div class="topMenu_bottom"> <!-- 상단 메뉴바에서 하단 메뉴 (소메뉴)-->
            <div class="miniMenu">
                <p class="miniMenu_title">프로젝트 정보 수정</p>
            </div>
        </div> 
    </div> <!-- 상단 메뉴바 컨테이너 끝 -->
    <div class="mainContent_container">
        ...
        <div class="contentArea">
            <form name="updateForm" method="post" action="/update_project.do">
            <input type="hidden" name="BNO" value="${dto.BNO}">
                <table class="contentTable">
                    <tr>
                        ...
                        <td colspan="3">
                            <div>
                                <input type="text" name="PROJECT_NAME" id="PROJECT_NAME" style=" width:300px; margin-left: 20px; height: 24px;" maxlength="30" value="${dto.PROJECT_NAME}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input type="text" name="PROJECT_AS" id="PROJECT_AS" class="inputStyle" value="${dto.PROJECT_AS}" maxlength="15">
                            </div>
                        </td>
                        <th style="width: 184px;">
                            <div>
                        ...
                        <td>
                            <div>
                                <input type="text" name="PROJECT_COMPANY" id="PROJECT_COMPANY" class="inputStyle" value="${dto.PROJECT_COMPANY}" readonly>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input type="text" name="START_DATE" id="START_DATE" class="inputStyle" value="${dto.START_DATE}" readonly>
                            </div>
                        </td>
                        <th>
                            <div>
                        ...
                        <td>
                            <div>
                                <input type="text" name="END_DATE" id="END_DATE" class="inputStyle" value="${dto.END_DATE}" readonly>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input type="text" name="CUSTOMER_MANAGER" id="CUSTOMER_MANAGER" class="inputStyle" value="${dto.CUSTOMER_MANAGER}" readonly>
                            </div>
                        </td>
                        <th>
                            <div>
                        ...
                        <td>
                            <div>
                                <input type="text" name="CUSTOMER_MAN_TEL" id="CUSTOMER_MAN_TEL" class="inputStyle" value="${dto.CUSTOMER_MAN_TEL}" readonly>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <div>
                                <input type="text" name="PROJECT_AMOUNT" id="PROJECT_AMOUNT" style=" width:715px; margin-left: 20px; height: 24px;" value="${dto.PROJECT_AMOUNT}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <div>
                                <textarea id="PROJECT_DETAILS" class="textStyle" wrap="hard" maxlength="500"></textarea> <!-- 여기에 입력하면 -->
                                <input type="hidden" name="PROJECT_DETAILS" id="sentText"> <!-- 여기로 저장되어 데이터 전송하고 -->
                                <input type="hidden" id="beforeMemo" value="${dto.PROJECT_DETAILS}"> <!-- 여기에 원래 값 저장해서 불러오게끔 하기 -->
                            </div>
                        </td>
                    </tr>
                </table>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#PROJECT_DETAILS').text(covertText);
